{ Copied and changed from standard Delphi XE3 delivery }
{--------------------------------------------------------------------------------}
{  Modify      |    Date    |      Contents       |        Description           }
{--------------------------------------------------------------------------------}
...
begin
  ...
  case OpenMode of
  //zmRead:      LMode := fmOpenRead;                     //original code
    zmRead:      LMode := fmOpenRead or fmShareDenyWrite; //shalamyansky 2017-11-05
