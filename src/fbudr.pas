...
TRoutineContext = class
  ...
  public
    ...
    function ReadInputBoolean(    Status:IStatus; FieldIndex:UINT32; out Value:BOOLEAN;       out IsNull:WORDBOOL ):BOOLEAN;
    function ReadInputShortint(   Status:IStatus; FieldIndex:UINT32; out Value:SHORTINT;      out IsNull:WORDBOOL ):BOOLEAN;
    ...
    function WriteOutputBoolean(  Status:IStatus; FieldIndex:UINT32;     Value:BOOLEAN;           IsNull:WORDBOOL ):BOOLEAN;
    function WriteOutputShortint( Status:IStatus; FieldIndex:UINT32;     Value:SHORTINT;          IsNull:WORDBOOL ):BOOLEAN;
...
function TRoutineContext.ReadInputBoolean( Status:IStatus; FieldIndex:UINT32; out Value:BOOLEAN; out IsNull:WORDBOOL ):BOOLEAN;
var
    vINT64 : INT64;
begin
    Result := FALSE;
    ...
    if( ReadInputOrdinal( Status, FieldIndex, vINT64, IsNull ) )then begin
        if( not IsNull )then begin
            Value := BOOLEAN( SHORTINT( vINT64 ) );
        end;
        Result := TRUE;
    end;
end;{ TRoutineContext.ReadInputShortint }

function TRoutineContext.ReadInputShortint( Status:IStatus; FieldIndex:UINT32; out Value:SHORTINT; out IsNull:WORDBOOL ):BOOLEAN;
var
    vINT64 : INT64;
begin
    Result := FALSE;
...
function TRoutineContext.WriteOutputBoolean( Status:IStatus; FieldIndex:UINT32; Value:BOOLEAN; IsNull:WORDBOOL ):BOOLEAN;
begin
    Result := WriteOutputOrdinal( Status, FieldIndex, INT64( Ord( Value ) ), IsNull );
end;{ TRoutineContext.WriteOutputBoolean }

function TRoutineContext.WriteOutputShortint( Status:IStatus; FieldIndex:UINT32; Value:SHORTINT; IsNull:WORDBOOL ):BOOLEAN;
begin
