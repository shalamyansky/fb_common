{ Copied and changed from standard Delphi 12 delivery }
{------------------------------------------------------------------------------}
{  Modify      |    Date    |      Contents         |      Description         }
{------------------------------------------------------------------------------}
{ shalamyansky | 2025-04-02 | Slash escaping banned |        no need           }
{------------------------------------------------------------------------------}
{*******************************************************}
{                                                       }
...
//      '/':                                      //shalamyansky 2025-04-02 commented
//        begin
//          Data[IncrAfter(Offset)] := Ord('\');
//          Data[IncrAfter(Offset)] := Ord('/');
//        end;
...
procedure TJSONString.ToChars(Builder: TStringBuilder; Options: TJSONAncestor.TJSONOutputOptions);
  ...
  begin
    ...
    begin
      ...
      '"': Builder.Append('\"');
      '\': Builder.Append('\\');
//    '/': Builder.Append('\/');  //shalamyansky 2025-04-02 commented
      #$8: Builder.Append('\b');
      #$9: Builder.Append('\t');
      #$a: Builder.Append('\n');
      #$c: Builder.Append('\f');
...
{$WARNINGS OFF}
  ...
  begin
    ...
    while P < PEnd do
    begin
      if P^ in ['"', '\',(*'/',*) #$8, #$9, #$a, #$c, #$d] then  //shalamyansky 2025-04-02 partial commented
        Exit(True);
      Inc(P);
    end;
    Result := False;
  ...
  begin
    ...
    begin
      case P^ of
      '"', '\',(*'/',*) #$8, #$9, #$a, #$c, #$d:  //shalamyansky 2025-04-02 partial commented
        Exit(True);
      #0 .. #7, #$b, #$e .. #31:
