{-----------------------------changes------------------------------------------}
{  Author  |  Date      |     Contents      |          Description             }
{------------------------------------------------------------------------------}
{  michel  | 2023-05-16 |  Classes deleted  | to avoid oleaut32.dll dependence }
{------------------------------------------------------------------------------}
{ Extracted from Firebird-4.0.2.2816-0.amd64.tar.gz }
