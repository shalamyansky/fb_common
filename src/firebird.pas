{ Extracted from Firebird-4.0.3.2975-0.amd64.tar.gz }
{-----------------------------changes------------------------------------------}
{   Changer  |  Date      |    Contents     |          Description             }
{------------------------------------------------------------------------------}
{shalamyansky| 2023-08-09 | Classes deleted | to avoid oleaut32.dll dependence }
{------------------------------------------------------------------------------}
...
uses
    //Classes,  shalamyansky 2023-08-09
    SysUtils
;
